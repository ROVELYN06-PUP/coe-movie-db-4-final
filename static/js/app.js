$(function() {
	...
	function displayInfo(data,poster,title,movId){
		...
		//data.results.forEach(function(movie) {
               ...
               var htmlStr = [
                               '<div class="viewer col-md-4 col-sm-6 portfolio-item">',
                                    '<div class="left-side">',
									'<a id="'+movId+'" class="idClick" href="#">',
                                        '<img class="img-responsive" src="' + poster + '" alt="" style="padding-left:90px;">',
                                    '</a></div>',
                                    '<h5 class="text-center">',
                                        '<a  class="title-top" href="#" style="color:orange;">' + title +'</a>',
                                    '</h5>',
									'<h5 class="text-center">',
	...
	function displayInfo2(data,movId){
		...
		//data.results.forEach(function(movie) {
               ...
               var htmlStr = [
							   '<div class="similar">',
                               '<div id="'+movId+'r" class="show-item-inline" style="float:left;">'+ title +'&nbsp | &nbsp</div>',
							   '</div>'
                            ];
	...
	function displayInfo4(data){
		...
		trailer.forEach(function(movie) {
               ...
               var htmlStr = [
							  ...
							  '<iframe width="320" height="195" src="//www.youtube.com/embed/'+vidLink+'" frameborder="0" allowfullscreen></iframe>'
                            ];
